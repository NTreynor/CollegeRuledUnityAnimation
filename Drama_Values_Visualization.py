...
def analyze_each_column(csv_filename, print = True):
    ...
    for col in range(df.shape[1]):
        ...
        min_values.append(column_stats.loc['min'])
        max_values.append(column_stats.loc['max'])
        median_values.append(column_stats.loc['50%'])  # 50% corresponds to the median
        first_quartile_values.append(column_stats.loc['25%'])
        third_quartile_values.append(column_stats.loc['75%'])
